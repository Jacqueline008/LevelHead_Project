...
<div id="logined_Admin_All_container">
    ...
    <div id="AdminInfo">
        ...
        <div id="AdminInfoLeft">
            ...
            <form id="AdminInfoForm" name="AdminInfoForm"
                  action="Logined_NormalUser.php" method="post" target="_self"
    ...
    <div id="showCarAndOrderAndTeArea">
        ...
        <br><br>
            <div id="showCarArea">
                查看我的购物车:
                <br><br><a id="showCar" href="ShoppingCar.php" target="_blank"><img src="images/mycar.jpg"/></a>
            </div>
            <div id="showOrderArea">
                查看我的订单:
                <br><br><a id="showOrder" href="UserOrderInfo.php" target="_blank"><img src="images/myorder.jpg"/></a>
            </div>
            <div id="showTeArea">
                已获得的特权:
